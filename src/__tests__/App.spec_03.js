...
describe('<App />', () => {
  ...
  it('should test handleClick() by calculating 1253 + 5', () => {
    const root = shallow(<App />)
    ...
    inst.handleClick('2')
    expect(inst.state.next).toEqual('12')
    
    inst.handleClick('5')
    expect(inst.state.next).toEqual('125')

    inst.handleClick('3')
    expect(inst.state.next).toEqual('1253')

    inst.handleClick('+')
    expect(inst.state.total).toEqual('1253')
    ...
    inst.handleClick('=')
    expect(inst.state.total).toEqual('1258')
