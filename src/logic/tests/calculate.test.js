...
describe('<calculate />', () => {
  ...
  describe('`calculate`', () => {
    it('should clear the display when \'AC\' button is clicked', () => {
      const AC = calculate({ total: '4534634653452', next: null, operation: null }, 'AC');
    ...
    it('should return total with a decimal point if \'.\' button is clicked', () => {
      const decimal = calculate({ total: '5', next: null, operation: null }, '.');
    ...
    it('should reverse the positive/negative value if \'+/-\' button is clicked', () => {
      const reverse = calculate({ total: null, next: '-198', operation: null }, '+/-');
